  ...
  return (
    <section style={{ backgroundImage: `url(${bg})` }} className={css.section}>
      <div className={css.hero}>
        ...
        <div className={css.logosInner}>
          <div className={css.langugageInner}>
            <h1 className={css.language} onClick={() => { languageChange(); openLanguageMenu(); }}>
              ENG
            </h1>
      ...
      <div className={`${css[changeLanguageClass]}`}>
        <button className={css.smallButton} onClick={openLanguageMenu}>RUS</button>
        <button className={css.smallButton} onClick={openLanguageMenu}>FRA</button>
        <button className={css.smallButton} onClick={openLanguageMenu}>DEU</button>
      </div>
